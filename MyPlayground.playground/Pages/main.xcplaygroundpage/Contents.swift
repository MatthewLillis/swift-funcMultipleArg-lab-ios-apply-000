...
func numberOfCountries(continent:String, number:Int) {
    print("\(continent) is a continent which contains \(number) countries.")
}
numberOfCountries(continent: "North America", number: 3)
 ...
 */
// write your code here
func roundSong(bottles:Int, what:String, wall:String) {
    print("\(bottles) bottles of \(what) on the \(wall) wall.")
}

roundSong(bottles: 99, what: "beer", wall: "bar")
